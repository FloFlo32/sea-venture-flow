...
export const reviews: Review[] = [
  ...
  },
  {
    ...
    body: "Fabulous snorkeling excursion with KoKo! He was extremely helpful and it was the best adventure. The fish and coral were beautiful at Mangel Halto Beach, and the Sea Scooters were a definite plus! Highly recommend Aruba Bob's Snorkel.",
    source: "TripAdvisor",
  },
  {
    name: "Kelly C.",
