...
export const posts: BlogPost[] = [
  {
    ...
    image: snorkel,
    body: "Aruba is one of the easiest Caribbean islands to snorkel — calm water, healthy reef and warm temperatures year-round. Our top pick is Mangel Halto for its mangroves and reef wall, followed by Boca Catalina for turtles, Arashi for the Antilla wreck, Baby Beach for a relaxed family swim, and Tres Trapi for guaranteed turtle sightings. Bring reef-safe sunscreen, a rash guard for sun protection, and consider a sea scooter — it makes covering the bigger reefs effortless.",
  },
  {
