...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { property: "og:title", content: "Aruba Bob — Snorkel, Scuba & Sea Scooter Tours" },
      { property: "og:description", content: "Adventure with the locals. Book unforgettable underwater experiences in Aruba." },
